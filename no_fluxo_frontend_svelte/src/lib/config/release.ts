...
export const RELEASE_NOTA_EQUIPE = {
	agradecimento:
		'Esta atualização é dedicada a cada estudante que já usou o NoFluxo, mandou feedback, fez parte da nossa história e sonhou com a gente. [Viramos manchete na UnB](https://noticias.unb.br/pesquisas-estudos-e-projetos/8676-estudantes-desenvolvem-plataforma-para-facilitar-planejamento-da-vida-academica), e nada disso seria possível sem a oportunidade que cada um de vocês deu de organizar a vida acadêmica por aqui.',
