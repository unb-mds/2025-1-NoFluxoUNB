<script lang="ts">
	...
	let { icon: Icon, title, description, index = 0 }: Props = $props();
...
<article
	class="feature-card"
	use:scrollReveal={{ delay: index * 50, threshold: 0.1 }}
>
