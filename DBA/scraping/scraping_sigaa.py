...
def get_discipline_details(session, discipline_id):
    ...
    try:
        ...
        if link_id:
            ...
            data["formListagemComponentes:j_id_jsp_190531263_23"] = (
                "formListagemComponentes:j_id_jsp_190531263_23"
            )
...
def get_department_disciplines(session, unidade_id, unidade_nome):
    ...
    try:
        ...
        if len(rows) == 0:
            ...
            print(
                f"  Aviso: Página HTML salva para debug em debug_unidade_{unidade_id}.html"
            )
        ...
        for row in rows:
            ...
            if len(cols) >= 5:  # Verificar se tem colunas suficientes
                ...
                if discipline_id:
                    print(
                        f"  Obtendo ementa de: {disciplina['codigo']} - {disciplina['nome']}"
                    )
...
def get_all_disciplines():
    ...
    try:
        ...
        for unidade in unidades:
            ...
            disciplines = get_department_disciplines(
                department_session, unidade_id, unidade_nome
            )
