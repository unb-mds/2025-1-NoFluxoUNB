...
-- Includes: 16 tables, 1 views, 164 functions, 3 triggers, 24 policies
...
CREATE TABLE IF NOT EXISTS public."dados_users_teste" (
  "id_dado_user" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  "created_at" timestamp with time zone DEFAULT now() NOT NULL,
  "fluxograma_atual" text DEFAULT '{}'::text,
  "id_user" bigint,
...
ALTER TABLE ONLY public."dados_users_teste" ADD CONSTRAINT "dados_users_teste_pkey" PRIMARY KEY ("id_dado_user");
...
ALTER TABLE ONLY public."dados_users_teste" ADD CONSTRAINT "dados_users_teste_id_user_fkey" FOREIGN KEY ("id_user") REFERENCES public."users"("id_user");
...
ALTER TABLE ONLY public."historicos_usuarios" ADD CONSTRAINT "historicos_usuarios_id_dado_user_fkey" FOREIGN KEY ("id_dado_user") REFERENCES public."dados_users"("id_dado_user");
ALTER TABLE ONLY public."historicos_usuarios" ADD CONSTRAINT "historicos_usuarios_id_user_fkey" FOREIGN KEY ("id_user") REFERENCES public."users"("id_user");
...
ALTER TABLE ONLY public."ticket_audit_log" ADD CONSTRAINT "ticket_audit_log_ticket_id_fkey" FOREIGN KEY ("ticket_id") REFERENCES public."tickets"("id");
ALTER TABLE ONLY public."turmas" ADD CONSTRAINT "turmas_id_materia_fkey" FOREIGN KEY ("id_materia") REFERENCES public."materias"("id_materia");
...
CREATE UNIQUE INDEX dados_users_teste_id_user_key ON public.dados_users_teste USING btree (id_user);
