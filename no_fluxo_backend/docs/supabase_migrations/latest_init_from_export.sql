...
-- Includes: 21 tables, 1 views, 181 functions, 5 triggers, 35 policies

BEGIN;

-- Sequences (created before tables that reference them)
CREATE SEQUENCE IF NOT EXISTS public.ai_usage_log_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.ticket_audit_log_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.tickets_id_seq;

CREATE TABLE IF NOT EXISTS public."admins" (
  "auth_id" uuid NOT NULL,
  "role" text DEFAULT 'admin'::text NOT NULL,
  "scopes" text[] DEFAULT ARRAY['tickets'::text, 'dashboard'::text] NOT NULL,
  "note" text,
...
CREATE TABLE IF NOT EXISTS public."ai_pricing" (
  "model" text NOT NULL,
  "input_per_1k" numeric DEFAULT '0' NOT NULL,
  "output_per_1k" numeric DEFAULT '0' NOT NULL,
...
CREATE TABLE IF NOT EXISTS public."ai_usage_log" (
  "id" bigint DEFAULT nextval('ai_usage_log_id_seq'::regclass) NOT NULL,
  "created_at" timestamp with time zone DEFAULT now() NOT NULL,
  "endpoint" text,
  "model" text,
...
CREATE TABLE IF NOT EXISTS public."dados_users" (
  ...
  "carga_horaria_integralizada" jsonb DEFAULT '{"total": 0, "optativa": 0, "obrigatoria": 0, "complementar": 0}'::jsonb,
  "optativas_manuais" jsonb DEFAULT '[]'::jsonb,
  "preferencias_plano" jsonb DEFAULT '{"objetivo": "equilibrado", "trabalha": false, "limiteCreditos": 24}'::jsonb
);
...
CREATE TABLE IF NOT EXISTS public."materias_vetorizadas" (
  "id_materia" bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS public."notificacoes" (
  "id_notificacao" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  "created_at" timestamp with time zone DEFAULT now() NOT NULL,
  "id_user" bigint NOT NULL,
  "tipo" text DEFAULT 'vaga_disponivel'::text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public."ticket_audit_log" (
  "id" bigint DEFAULT nextval('ticket_audit_log_id_seq'::regclass) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public."turmas" (
  "id_turmas" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  "id_materia" bigint NOT NULL,
  "created_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public."vaga_assinaturas" (
  "id_assinatura" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  "created_at" timestamp with time zone DEFAULT now() NOT NULL,
  "id_user" bigint NOT NULL,
  "id_materia" bigint NOT NULL,
  "turma" text,
...
ALTER TABLE ONLY public."admins" ADD CONSTRAINT "admins_pkey" PRIMARY KEY ("auth_id");
ALTER TABLE ONLY public."ai_pricing" ADD CONSTRAINT "ai_pricing_pkey" PRIMARY KEY ("model");
...
ALTER TABLE ONLY public."historicos_usuarios" ADD CONSTRAINT "historicos_usuarios_pkey" PRIMARY KEY ("id_historico");
...
ALTER TABLE ONLY public."materias_vetorizadas" ADD CONSTRAINT "materias_vetorizadas_pkey" PRIMARY KEY ("id_materia");
ALTER TABLE ONLY public."matrizes" ADD CONSTRAINT "matrizes_pkey" PRIMARY KEY ("id_matriz");
ALTER TABLE ONLY public."notificacoes" ADD CONSTRAINT "notificacoes_pkey" PRIMARY KEY ("id_notificacao");
...
ALTER TABLE ONLY public."ticket_audit_log" ADD CONSTRAINT "ticket_audit_log_pkey" PRIMARY KEY ("id");
ALTER TABLE ONLY public."tickets" ADD CONSTRAINT "tickets_pkey" PRIMARY KEY ("id");
ALTER TABLE ONLY public."turmas" ADD CONSTRAINT "turmas_pkey" PRIMARY KEY ("id_turmas");
ALTER TABLE ONLY public."turmas_historico" ADD CONSTRAINT "turmas_historico_pkey" PRIMARY KEY ("id_historico");
ALTER TABLE ONLY public."users" ADD CONSTRAINT "users_pkey" PRIMARY KEY ("id_user");
ALTER TABLE ONLY public."vaga_assinaturas" ADD CONSTRAINT "vaga_assinaturas_pkey" PRIMARY KEY ("id_assinatura");
...
ALTER TABLE ONLY public."historicos_usuarios" ADD CONSTRAINT "historicos_usuarios_id_dado_user_fkey" FOREIGN KEY ("id_dado_user") REFERENCES public."dados_users"("id_dado_user") ON DELETE SET NULL;
ALTER TABLE ONLY public."historicos_usuarios" ADD CONSTRAINT "historicos_usuarios_id_user_fkey" FOREIGN KEY ("id_user") REFERENCES public."users"("id_user") ON DELETE CASCADE;
...
ALTER TABLE ONLY public."notificacoes" ADD CONSTRAINT "notificacoes_id_user_fkey" FOREIGN KEY ("id_user") REFERENCES public."users"("id_user") ON DELETE CASCADE;
...
ALTER TABLE ONLY public."ticket_audit_log" ADD CONSTRAINT "ticket_audit_log_ticket_id_fkey" FOREIGN KEY ("ticket_id") REFERENCES public."tickets"("id") ON DELETE CASCADE;
ALTER TABLE ONLY public."turmas" ADD CONSTRAINT "turmas_id_materia_fkey" FOREIGN KEY ("id_materia") REFERENCES public."materias"("id_materia") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE ONLY public."turmas_historico" ADD CONSTRAINT "turmas_historico_id_materia_fkey" FOREIGN KEY ("id_materia") REFERENCES public."materias"("id_materia") ON DELETE CASCADE;
ALTER TABLE ONLY public."turmas_historico" ADD CONSTRAINT "turmas_historico_id_turmas_fkey" FOREIGN KEY ("id_turmas") REFERENCES public."turmas"("id_turmas") ON DELETE SET NULL;
...
CREATE INDEX idx_ai_usage_created_at ON public.ai_usage_log USING btree (created_at DESC);
CREATE INDEX idx_ai_usage_model ON public.ai_usage_log USING btree (model);
CREATE INDEX idx_cursos_turno ON public.cursos USING btree (turno);
CREATE UNIQUE INDEX dados_users_id_user_unique ON public.dados_users USING btree (id_user);
CREATE INDEX idx_historicos_usuarios_created_at ON public.historicos_usuarios USING btree (created_at);
CREATE INDEX idx_historicos_usuarios_id_dado_user ON public.historicos_usuarios USING btree (id_dado_user);
CREATE INDEX idx_historicos_usuarios_id_user ON public.historicos_usuarios USING btree (id_user);
...
CREATE INDEX idx_notificacoes_id_user_nao_lida ON public.notificacoes USING btree (id_user, created_at DESC) WHERE (NOT lida);
CREATE INDEX idx_ticket_audit_ticket ON public.ticket_audit_log USING btree (ticket_id, created_at);
...
CREATE UNIQUE INDEX uq_turmas_oferta ON public.turmas USING btree (id_materia, turma, ano_periodo);
CREATE INDEX idx_turmas_historico_materia_periodo ON public.turmas_historico USING btree (id_materia, ano_periodo, observed_at DESC);
CREATE INDEX idx_turmas_historico_observed_at ON public.turmas_historico USING btree (observed_at);
...
CREATE INDEX idx_vaga_assinaturas_id_user ON public.vaga_assinaturas USING btree (id_user);
CREATE INDEX idx_vaga_assinaturas_materia_ativa ON public.vaga_assinaturas USING btree (id_materia, ano_periodo) WHERE ativa;
CREATE UNIQUE INDEX uq_vaga_assinatura ON public.vaga_assinaturas USING btree (id_user, id_materia, turma, ano_periodo);
...
CREATE POLICY "admins_delete_superadmin" ON public."admins" AS PERMISSIVE FOR DELETE TO authenticated USING (is_superadmin());
CREATE POLICY "admins_insert_superadmin" ON public."admins" AS PERMISSIVE FOR INSERT TO authenticated USING (true) WITH CHECK (is_superadmin());
CREATE POLICY "admins_select_self_or_superadmin" ON public."admins" AS PERMISSIVE FOR SELECT TO authenticated USING (((auth_id = auth.uid()) OR is_superadmin()));
CREATE POLICY "admins_update_superadmin" ON public."admins" AS PERMISSIVE FOR UPDATE TO authenticated USING (is_superadmin()) WITH CHECK (is_superadmin());
CREATE POLICY "ai_pricing_select_dashboard" ON public."ai_pricing" AS PERMISSIVE FOR SELECT TO authenticated USING (has_admin_scope('dashboard'::text));
CREATE POLICY "ai_pricing_write_superadmin" ON public."ai_pricing" AS PERMISSIVE FOR ALL TO authenticated USING (is_superadmin()) WITH CHECK (is_superadmin());
CREATE POLICY "ai_usage_select_dashboard" ON public."ai_usage_log" AS PERMISSIVE FOR SELECT TO authenticated USING (has_admin_scope('dashboard'::text));
...
CREATE POLICY "historicos_usuarios_insert_own" ON public."historicos_usuarios" AS PERMISSIVE FOR INSERT TO authenticated USING (true) WITH CHECK ((id_user IN ( SELECT users.id_user
   FROM users
  WHERE (users.auth_id = auth.uid()))));
CREATE POLICY "historicos_usuarios_select_own" ON public."historicos_usuarios" AS PERMISSIVE FOR SELECT TO authenticated USING ((id_user IN ( SELECT users.id_user
   FROM users
  WHERE (users.auth_id = auth.uid()))));
...
CREATE POLICY "notificacoes_select_own" ON public."notificacoes" AS PERMISSIVE FOR SELECT TO authenticated USING ((id_user IN ( SELECT users.id_user
   FROM users
  WHERE (users.auth_id = auth.uid()))));
CREATE POLICY "notificacoes_update_own" ON public."notificacoes" AS PERMISSIVE FOR UPDATE TO authenticated USING ((id_user IN ( SELECT users.id_user
   FROM users
  WHERE (users.auth_id = auth.uid())))) WITH CHECK ((id_user IN ( SELECT users.id_user
   FROM users
  WHERE (users.auth_id = auth.uid()))));
...
CREATE POLICY "audit_select_own_or_admin" ON public."ticket_audit_log" AS PERMISSIVE FOR SELECT TO authenticated USING ((is_ticket_admin() OR (EXISTS ( SELECT 1
   FROM tickets t
  WHERE ((t.id = ticket_audit_log.ticket_id) AND (t.created_by = auth.uid()))))));
CREATE POLICY "tickets_delete_admin" ON public."tickets" AS PERMISSIVE FOR DELETE TO authenticated USING (is_ticket_admin());
CREATE POLICY "tickets_insert_own" ON public."tickets" AS PERMISSIVE FOR INSERT TO authenticated USING (true) WITH CHECK ((created_by = auth.uid()));
CREATE POLICY "tickets_select_own_or_admin" ON public."tickets" AS PERMISSIVE FOR SELECT TO authenticated USING (((created_by = auth.uid()) OR is_ticket_admin()));
CREATE POLICY "tickets_update_admin" ON public."tickets" AS PERMISSIVE FOR UPDATE TO authenticated USING (is_ticket_admin()) WITH CHECK (is_ticket_admin());
CREATE POLICY "turmas_select_public" ON public."turmas" AS PERMISSIVE FOR SELECT TO authenticated USING (true);
...
CREATE POLICY "vaga_assinaturas_delete_own" ON public."vaga_assinaturas" AS PERMISSIVE FOR DELETE TO authenticated USING ((id_user IN ( SELECT users.id_user
   FROM users
  WHERE (users.auth_id = auth.uid()))));
CREATE POLICY "vaga_assinaturas_insert_own" ON public."vaga_assinaturas" AS PERMISSIVE FOR INSERT TO authenticated USING (true) WITH CHECK ((id_user IN ( SELECT users.id_user
   FROM users
  WHERE (users.auth_id = auth.uid()))));
CREATE POLICY "vaga_assinaturas_select_own" ON public."vaga_assinaturas" AS PERMISSIVE FOR SELECT TO authenticated USING ((id_user IN ( SELECT users.id_user
   FROM users
  WHERE (users.auth_id = auth.uid()))));
CREATE POLICY "vaga_assinaturas_update_own" ON public."vaga_assinaturas" AS PERMISSIVE FOR UPDATE TO authenticated USING ((id_user IN ( SELECT users.id_user
   FROM users
  WHERE (users.auth_id = auth.uid())))) WITH CHECK ((id_user IN ( SELECT users.id_user
   FROM users
  WHERE (users.auth_id = auth.uid()))));
