...
class UploadService {
	...
	async casarDisciplinas(
		...
		// O currículo extraído do histórico é mantido como está, mesmo que a matriz esteja
		// "inativa" no SIGAA — o fluxograma deve ser fiel à matriz em que o aluno de fato está,
		// não à matriz "ativa" mais recente do curso.
